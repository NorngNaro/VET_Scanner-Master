...
import com.udaya.virak_buntham.vetpickup.activities.pickUp.PickUpDetailActivity;
...
public class LockerDetailActivity extends AppCompatActivity implements
    ...
    public static String date, code, receiverTel,senderTel, reference, lockerName;
    public static String lats, longs;
...
/*        btnAddLocal.setOnClickListener(v -> {
    ...
    private void setData() {
        ...
        tvSenderAdd.setText(reference);
        tvCustomer.setText(lockerName);
   ...
   */ }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        try {
            ...
            LatLng latLng = new LatLng(Double.parseDouble(lats), Double.parseDouble(longs));
            ...
            public void onResponse(@NonNull Call<ScanQrRespone> call, @NonNull Response<ScanQrRespone> response) {
                if (response.isSuccessful()) {
                    ...
                    if (response.body().getStatus().equals("1")) {
                        showDialogCheck();
                        RequestParams.persistRequestParams(LockerDetailActivity.this
                    ...
                    Toast.makeText(LockerDetailActivity.this, "incorrect_code", Toast.LENGTH_SHORT).show();
                }
                progressDialog.hide();
            }

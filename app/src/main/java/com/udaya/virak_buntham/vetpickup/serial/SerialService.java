package com.udaya.virak_buntham.vetpickup.serial;
...
public class SerialService extends Service implements SerialListener {
    ...
    private void createNotification() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel nc = new NotificationChannel(ConstantUtil.NOTIFICATION_CHANNEL, "Background service", NotificationManager.IMPORTANCE_LOW);
            nc.setShowBadge(false);
            NotificationManager nm = (NotificationManager) getSystemService(Context.NOTIFICATION_SERVICE);
            nm.createNotificationChannel(nc);
        }
        Intent disconnectIntent = new Intent()
                .setAction(ConstantUtil.INTENT_ACTION_DISCONNECT);
        Intent restartIntent = new Intent()
                .setClassName(this, ConstantUtil.INTENT_CLASS_MAIN_ACTIVITY)
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, ConstantUtil.NOTIFICATION_CHANNEL)
        ...
        startForeground(ConstantUtil.NOTIFY_MANAGER_START_FOREGROUND_SERVICE, notification);
    }

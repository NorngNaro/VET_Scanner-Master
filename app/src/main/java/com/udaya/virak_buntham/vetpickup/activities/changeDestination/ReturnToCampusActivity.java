...
public class ReturnToCampusActivity extends AppCompatActivity implements View.OnClickListener, OnInternetConnectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_return_to_campus);
        progressDialog = new ProgressDialog(this);
        ButterKnife.bind(this);
        mToolbarTitle.setText("ត្រលប់ទៅសាខាកណ្តាល");
        ...
        findViewById(R.id.imgSearchTel).setOnClickListener(v -> {
            if (branchId.isEmpty()) {
                ...
                if (edtTel.getText().toString().trim().isEmpty()) {
                    ...
                    ChangeAddManualActivity.condition = "returnHQ";
                ...
                if (response.isSuccessful()) {
                    if (response.body() != null) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            //Replace token
                            RequestParams.persistRequestParams(ReturnToCampusActivity.this
                            ...
                            tvtotalScan.setText(""+response.body().getItemScan().size());
                            tvQty.setText(""+response.body().getItemScan().size());
...
//                            tvReceiverTel.setText(response.body().getSender());
                            ...
                            try {
                                InputMethod.hideSoftKeyboard(ReturnToCampusActivity.this);
                            } catch (Exception e) {
                                Log.d("error==>", e.toString());
                            }
                            Toast.makeText(ReturnToCampusActivity.this, "" + response.body().getInfo(), Toast.LENGTH_SHORT).show();
                            MediaPlayer sound = MediaPlayer.create(ReturnToCampusActivity.this, R.raw.wrong_voice);
                            sound.start();
    ...
    private void processSave(String device, String token, String signature, String session,
        ...
        ApiInterface apiService = ApiClient.getClient(this, this).create(ApiInterface.class);
        Call<SaveResponse> call = apiService.savereturncenter(device, token, signature, session, goodTransferId, branchId, customerReceiverId, num);
                    ...
                    if (response.body() != null) {
                        if (response.body().getStatus().equals("1")) {
                            ...
                            if(getVersion.equals("New")){
                                ...
                                PrintLayoutActivity.condition = "returnHQ";
                                ...
                                PrintLayoutOldActivity.condition = "returnHQ";
        ...
        switch (v.getId()) {
            ...
            case R.id.imgScanQr:
                if (branchId.isEmpty()) {
                    ...
                    ScanChangeDestinationActivity.condition = "returnHQ";

...
public class PrintGTReceiptLocalActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    @BindView(R.id.view_print_qr_COD_Check_title)
    TextView viewCollectCodValueTitle;
    ...
    @BindView(R.id.view_print_qr_COD_Check_print_Title)
    TextView viewCollectCodValuePrintTitle;
...
// Initial new printer
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_print_gtreceipt_local);
        ButterKnife.bind(this);


        Log.e(TAG, "onCreate: Fuck you " );
        ...
        if (getIntent().getExtras() != null) {
            ...
            if (printData.getPoint()==0){
                transferFee.setText(getFeeWithSymbol(printData.getTotalAmount(), printData.getNormalSymbol()));
            }else {
                transferFee.setText("0៛ (Saving Point)");
            }
...
//            branchToTel.setText(printData.getBranchToTel());
            ...
            if (printData.getCollectCod().equals("0")) {
                ...
                viewCollectCodValueTitle.setVisibility(View.GONE);
                viewCollectCodValuePrint.setVisibility(View.GONE);
                viewCollectCodValuePrintTitle.setVisibility(View.GONE);
            } else {
            ...
            printQrItemCode.setText(printData.getItemCode() + "\1");
...
//            GlideApp.with(this).load(printData.getQrCode()).into(imageQrCode);
            ...
            valueQrCodeData = printData.getTransferCode() + "," + printData.getReceiver() + "," + "1";
            try {
            ...
            viewPrintQrItemCode.setText(printData.getItemCode() + "\1");
            ...
            Log.d("imageQr==>", "" + printData.getQrCode());
...
//                Bitmap _bitmapQR = getViewBitmap(mRecyclerView);
...
//                gotoHome();
    ...
    private HandlerUtils.IHandlerIntent iHandlerIntent = new HandlerUtils.IHandlerIntent() {
        ...
        public void handlerIntent(Message msg) {
            switch (msg.what) {
                case MSG_IS_BUSY:
                    Toast.makeText(PrintGTReceiptLocalActivity.this, R.string.printer_is_working, Toast.LENGTH_SHORT).show();
                    break;
                case MSG_PAPER_LESS:
                    Toast.makeText(PrintGTReceiptLocalActivity.this, R.string.out_of_paper, Toast.LENGTH_SHORT).show();
                    break;
                case MSG_PAPER_EXISTS:
                    Toast.makeText(PrintGTReceiptLocalActivity.this, R.string.exists_paper, Toast.LENGTH_SHORT).show();
                    break;
                case MSG_THP_HIGH_TEMP:
                    Toast.makeText(PrintGTReceiptLocalActivity.this, R.string.printer_high_temp_alarm, Toast.LENGTH_SHORT).show();
                    break;
                case MSG_MOTOR_HIGH_TEMP:
                    Toast.makeText(PrintGTReceiptLocalActivity.this, R.string.motor_high_temp_alarm, Toast.LENGTH_SHORT).show();
                ...
                case MSG_CURRENT_TASK_PRINT_COMPLETE:
                    Toast.makeText(PrintGTReceiptLocalActivity.this, R.string.printer_current_task_print_complete, Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }

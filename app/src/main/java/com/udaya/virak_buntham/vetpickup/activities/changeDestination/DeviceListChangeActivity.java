...
public class DeviceListChangeActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Get a set of currently paired devices
        if (ContextCompat.checkSelfPermission(DeviceListChangeActivity.this, Manifest.permission.BLUETOOTH_CONNECT) == PackageManager.PERMISSION_DENIED) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                ActivityCompat.requestPermissions(DeviceListChangeActivity.this, new String[]{Manifest.permission.BLUETOOTH_CONNECT}, 2);
                return;
            }
        }
...
//            String noDevices = getResources().getText(R.string.none_paired).toString();
    ...
    protected void onDestroy() {
        ...
        if (mBtAdapter != null) {
            if (ContextCompat.checkSelfPermission(DeviceListChangeActivity.this, Manifest.permission.BLUETOOTH_SCAN) == PackageManager.PERMISSION_DENIED) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    ActivityCompat.requestPermissions(DeviceListChangeActivity.this, new String[]{Manifest.permission.BLUETOOTH_SCAN}, 2);
                    return;
                }
            }
